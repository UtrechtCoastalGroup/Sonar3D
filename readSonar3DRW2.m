...
header.when = datevec(dateTime,'dd/mm/yy HH:MM:SS');
...
for line = 4:26
    ...
    informationString = strrep(informationString,char(0181),'mu');  % change mu
    informationString = strrep(informationString,' ','');           % remove any blanks
    informationString = strrep(informationString,'.','');           % remove any dots
    informationString = strrep(informationString,char(176),'');     % remove angle notation
    informationString = strrep(informationString,'%','');           % change %
    informationString = strrep(informationString,'in09steps','');
    informationString = strrep(informationString,'inmusec','');
